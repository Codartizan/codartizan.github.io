                                    ...
                                    if ((y(".position-relative h2", r).remove(), r.querySelector("include-fragment"))) setTimeout(g, 500);
                                        ...
                                        if (!1 !== m.global_stats) {
                                            var i = h(y("svg", r).outerHTML),
                                                c = i.current_streak
                                                    ? M(i.current_streak_range[0], _) + " &ndash; " + M(i.current_streak_range[1], _)
                                                    : i.last_contributed
                                                        ? "Last contributed in " + M(i.last_contributed, _) + "."
                                                        : "Rock - Hard Place",
                                                l = i.longest_streak
                                                    ? M(i.longest_streak_range[0], _) + " &ndash; " + M(i.longest_streak_range[1], _)
                                                    : i.last_contributed
                                                        ? "Last contributed in " + M(i.last_contributed, _) + "."
                                                        : "Rock - Hard Place",
                                                d = y("<div>", {
                                        ...
                                        !0 === m.tooltips &&
                                        ((n = b),
                                            (u = document.createElement("div")).classList.add("day-tooltip"),
                                            n.appendChild(u),
                                            n.querySelectorAll("rect.ContributionCalendar-day").forEach(function (e) {
                            ...
                            e
                                ...
                                .forEach(function (e) {
                                    ...
                                    if (((t = t && t[1]), (n = n && n[1]), (r = r && +r[1]), t)) {
                                        ...
                                        0 === s.current_streak && (s.current_streak_range[0] = a.date),
                                            a.count ? (++s.current_streak, (s.last_year += a.count), (s.last_contributed = a.date), (s.current_streak_range[1] = a.date)) : (o(), (s.current_streak = 0)),
                                            u.push(a),
                                            s.days.push(a);
                                    }
                                }),
